...
var ConsolePanel = React.createClass({
  ...
  componentWillMount: function() {
    this.controller = require('./controller-ConsolePanel')(this.props.controller, this);
    this.title = (
      <h1>Console</h1>
    );
  },
  ...
  render: function() {
    ...
    return (
      <Panel collapsible expanded={this.expanded} header={this.title}>
         <div>Console Panel contents here</div>
        {/*
        <Grid>
          <Row>
            <Col md={4}>
            ...
            <Col md={4}>
              <div>Master Process details</div>
            </Col>
            <Col md={4}>
              <div>Child Process details</div>
            </Col>
          </Row>
        </Grid>
        */}
